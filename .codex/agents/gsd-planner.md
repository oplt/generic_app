...
<execution_context>
@/home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/workflows/execute-plan.md
@/home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/templates/summary.md
</execution_context>
...
```bash
INIT=$(node "/home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/bin/gsd-tools.cjs" init plan-phase "${PHASE}")
...
```bash
node "/home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/bin/gsd-tools.cjs" history-digest
```
...
@/home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/references/thinking-models-planning.md
...
```bash
VALID=$(node "/home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/bin/gsd-tools.cjs" frontmatter validate "$PLAN_PATH" --schema plan)
```
...
```bash
STRUCTURE=$(node "/home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/bin/gsd-tools.cjs" verify plan-structure "$PLAN_PATH")
```
...
```bash
node "/home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): create phase plan" --files .planning/phases/$PHASE-*/$PHASE-*-PLAN.md .planning/ROADMAP.md
```
</step>
