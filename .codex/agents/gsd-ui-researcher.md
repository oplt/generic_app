...
Use template from `/home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
