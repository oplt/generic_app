...
import { getProjectSummary, listProjects } from "../../../api/projects";
        ...
        <PageShell maxWidth="xl">
            ...
            >
                <StatCard
                    ...
                    value={projectSummaryQuery.data?.project_count ?? projects?.length ?? 0}
                    description={`Total ${coreDomainPlural.toLowerCase()} in your workspace`}
                    icon={<ProjectsIcon />}
                    loading={projectsLoading || projectSummaryQuery.isLoading}
                />
                <StatCard
                    ...
                    loading={notificationsLoading || unreadCountQuery.isLoading}
                    color="warning"
                />
                <StatCard
                    label="Email status"
